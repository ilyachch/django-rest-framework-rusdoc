...
При использовании в состав просматриваемого API будет входить элемент управления `SearchFilter`:
...
Общие фильтры также могут представлять интерфейс в просматриваемом API. Для этого необходимо реализовать метод `to_html()`, который возвращает отрендеренное HTML-представление фильтра. Этот метод должен иметь следующую сигнатуру:
