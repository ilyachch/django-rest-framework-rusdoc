...
В DRF рекомендуется использовать сторонние пакеты для генерации и представления схем OpenAPI, поскольку они предлагают больше возможностей и гибкости, чем встроенная (устаревшая) реализация.
