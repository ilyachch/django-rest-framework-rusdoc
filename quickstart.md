...
Наконец, мы включаем стандартные представления входа и выхода для использования с Web-версией API. Это необязательно, но полезно, если ваш API требует аутентификации, а вы хотите использовать Web версию API.
