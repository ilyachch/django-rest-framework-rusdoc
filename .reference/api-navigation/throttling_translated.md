...
Вы также можете установить политику дросселя на основе для каждого вида или на расстоянии для каждого вида, используя представления на основе класса Apiview`.
...
Дополнительный контекст о том, как работает заголовок `x-forwarded-for`, и идентификация удаленного клиента IP может быть [найдено здесь] (http://oxpedia.org/wiki/index.php?title=pringsuet
Анкет
