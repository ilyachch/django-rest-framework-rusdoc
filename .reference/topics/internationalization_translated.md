...
>
> - [Яннис Лейдель, выступая в Джанго под капюшоном, 2015] (https://youtu.be/wa0vfs2q94y).
...
Структура REST составляет с переводимыми сообщениями об ошибках.
...
5. Запустите `Manage.py Compilemessages -l PT_BR`, чтобы сделать переводы доступными для использования Django.
