...
Наконец, нам нужно добавить эти представления в API, ссылаясь на них из URL Conf.
...
В этом случае тот, который мы ищем,-это «isauthenticatedordeReadonly», что обеспечит доступ к аутентифицированным запросам получить доступ к чтению-записи, а неавтоцированные запросы получают доступ только для чтения.
...
Теперь, если вы снова откроете браузер и обновите страницу, вы увидите ссылку «ловить» в правом верхнем углу страницы.
