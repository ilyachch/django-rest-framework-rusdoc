...
Использование `PUT` для операций создание является проблематичной задачей, так как это обязаельно раскроет информацию о существовании или отсутствии объектов. Также не совсем очевидно преимущество прозрачного воссоздания удаленных экземпляров перед обычным возвратом соообщений `404`.
