...
* Web-версия API - огромный выигрыш в удобстве использования для ваших разработчиков.
...
* [Markdown](https://pypi.org/project/markdown/) (3.0.0+) - Поддержка Markdown для Web-версии API.
...
Если вы планируете использовать Web версию API, вы, вероятно, также захотите добавить представления входа и выхода из системы REST framework. Добавьте следующее в ваш корневой файл `urls.py`.
