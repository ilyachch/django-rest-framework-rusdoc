...
Схемы могут быть полезным инструментом для автоматически создаваемой документации, а также могут быть использованы для динамического клиентских библиотек, которые могут взаимодействовать с API.
