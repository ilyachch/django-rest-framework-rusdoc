...
Проверьте работу API из командной строки, как это делалось в [Уроке 1]. Все работает одинаково, при этом мы получили улучшеную обработку ошибок в случае отправки неверных запросов.
