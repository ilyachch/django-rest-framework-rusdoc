# Урок 1: Сериализация {#tutorial-1-serialization}
...
Руководство достаточно подробное, так что если вы хотите только поверхностный обзор, воспользуйтесь руководством по [быстрому старту](/bistrii-start.md).
